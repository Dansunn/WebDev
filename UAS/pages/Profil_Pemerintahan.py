...
with main_container:
    st.write(' ')
    st.write(' ')
    st.markdown("<h3 style='text-align: center; color:white;'>Profil Pemerintahan</h1>", unsafe_allow_html=True)
    ...
    with col4:
        st.markdown("<p style='text-align: center; color:white;'>Gubernur DKI Jakarta</p>", unsafe_allow_html=True)
    ...
    with col5:
         st.write('')
    with col6:
        st.markdown("<p style='text-align: center; color:white;'>Wakil Gubernur DKI Jakarta</p>", unsafe_allow_html=True)
